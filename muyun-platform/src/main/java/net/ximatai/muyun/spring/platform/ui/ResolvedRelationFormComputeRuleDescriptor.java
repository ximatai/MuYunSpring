...
public record ResolvedRelationFormComputeRuleDescriptor(String code, FormulaProgram program,
                                                        String targetField, String targetValueType,
    ...
    public ResolvedRelationFormComputeRuleDescriptor {
        ...
        if (targetValueType == null || targetValueType.isBlank() || "JSON".equals(targetValueType))
            throw new IllegalArgumentException("relation form compute target field requires a portable value type: " + targetField);
