...
import net.ximatai.muyun.spring.platform.notification.BusinessNotificationCommandAction;
        ...
        notificationService.publish(new BusinessNotification(
                ...
                List.of(
                        new BusinessNotificationNavigateAction("view", "查看学生", "education.student", null,
                                "LIST", Map.of(), false),
                        new BusinessNotificationCommandAction("approve", "同意", "education.demo.approve",
                                Map.of("notificationId", notificationId), false, null, true),
                        new BusinessNotificationCommandAction("reject", "拒绝", "education.demo.reject",
                                Map.of("notificationId", notificationId), true, "确认拒绝这份学生档案？", true))));
