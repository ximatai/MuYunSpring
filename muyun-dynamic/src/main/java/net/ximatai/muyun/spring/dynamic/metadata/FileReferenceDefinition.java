...
/**
 * Source-neutral constraints for one persisted MuYunFileServer file identifier.
 * A collection of files remains a RecordAttachment relation in v1.
 */
public record FileReferenceDefinition(Set<String> allowedMediaTypes, Long maxFileSizeBytes) {
    ...
    public static FileReferenceDefinition unrestricted() {
        return new FileReferenceDefinition(Set.of(), null);
    }
